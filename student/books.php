...
<!-- ---------------------searchbar------------------------- -->
	...
	<section id="search">
		...
		<form class="navbar-form" method="post" method="form1">
			...
			<form class="navbar-form" method="post" method="form1">
			<div>
				<input class="" type="text" name="bid" placeholder="Enter Book ID">

				<button type="submit" name="submit1" class="btn btn-default">Request</button>
			</div>
		</form>
	</div>
				</div>
...
?>
	...
	else
	{
		?>
		<script type="text/javascript">
			alert("You must to Login to Request a Book")
		</script>
