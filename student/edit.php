...
<body style="background-color: #004528;">
	...
	<h2 style="text-align: center;color: #fff; padding-top: 10px;">Edit Information</h2>
	<?php
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE student SET pic='$pic', firstname='$first', lastname='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";
